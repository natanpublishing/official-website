...
<html lang="id">
	<head>
		...
		<!-- Title -->
		<title>Layanan | <?php echo $sitetitle ?></title>

		<!-- Mobile Meta -->
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		
		<!-- Meta Tag -->
		<meta name="title" content="Layanan | <?php echo $sitetitle ?>">
		<meta name="description" content="Layanan <?php echo $sitetitle ?>, <?php echo $sitedescription ?>.">
		<meta name="robots" content="index, nofollow">
		<meta name="author" content="<?php echo $sitetitle ?>">
		
		<!-- Meta Share -->
		<meta property="og:title" content="Layanan | <?php echo $sitetitle ?>">
		<meta property="og:image" content="<?php echo $siteurl ?>assets/img/thumb.jpg">
		<meta property="og:description" content="Layanan <?php echo $sitetitle ?>, <?php echo $sitedescription ?>.">
									...
									<div class="tt-ol-menu-inner tt-wrap">
										<div class="tt-ol-menu-content">
											...
											<ul class="tt-ol-menu-list">
												...
												<li class="active"><a href="<?php echo $siteurl ?>service/">Layanan</a></li>
						...
						<div class="page-header-inner tt-wrap">
							...
							<div class="ph-caption max-width-1000">
								<div class="ph-caption-subtitle">
									<div class="ph-appear">Layanan Kami</div>
								</div>
								<h1 class="ph-caption-title">
									<div class="ph-appear">Layanan</div> <!-- You can use <br> to break a text line if needed -->
								</h1>
								<div class="ph-caption-title-ghost">
									<div class="ph-appear">Layanan</div>
								</div>
							</div>
									...
									<div class="tt-col-lg-4">
										...
										* Use prepared helper class "max-width-*" to add custom width if needed. Example: "max-width-800". More info about helper classes can be found in the file "helper.css".
										...
										<div class="tt-heading tt-heading-xlg anim-fadeinup">
											<h2 class="tt-heading-title">Dunia Kreatif Digital</h2> <!-- You can use <br> to break a text line if needed -->
										</div>
										<!-- End tt-Heading -->

										<div class="max-width-600 margin-bottom-60 anim-fadeinup">
											<h5>Kami memberikan solusi kreatif dan berorientasi pada hasil untuk mengembangkan bisnis Anda dalam bentuk digital.</h5>
										</div>
										...
										<div class="tt-accordion tt-ac-borders">
											<div class="tt-accordion-item anim-fadeinup">
												...
												<div class="tt-accordion-content max-width-800">
													<p>Kami akan menciptakan sebuah merek yang kuat untuk Anda agar siap untuk dipasarkan pada hari ini dan esok. Layanan ini mencakup <span class="text-dark-3">Research & Ideation</span>, <span class="text-dark-3">Consultant</span>, <span class="text-dark-3">Marketing Collateral Design</span>, <span class="text-dark-3">Brand Identity Design</span>, <span class="text-dark-3">Marketing Collaterals Production</span>.</p>
											...
											<div class="tt-accordion-item anim-fadeinup">
												...
												<div class="tt-accordion-content max-width-800">
													<p>Kami akan merancang situs web Anda dengan storytelling yang kuat. Baik itu pengembangan, desain dan pemeliharaan. Kami akan membuat desain khusus yang responsif di berbagai macam perangkat. Layanan ini mencakup <span class="text-dark-3">Research & Ideation</span>, <span class="text-dark-3">Consultant</span>, <span class="text-dark-3">Development</span>, <span class="text-dark-3">Maintenance</span>, <span class="text-dark-3">Content Production</span>.</p>
												</div> <!-- /.tt-accordion-content -->
											</div> <!-- /.tt-accordion-item -->
											...
											<div class="tt-accordion-item anim-fadeinup">
												<div class="tt-accordion-heading">
													<div class="tt-ac-head cursor-alter">
														<h3 class="tt-ac-head-title">Search Engine Optimization</h3>
												...
												<div class="tt-accordion-content max-width-800">
													<p>Kami akan membuat dan mempertahankan produk Anda berada diurutan terbaik untuk mesin pencari di internet. Layanan ini mencakup <span class="text-dark-3">Research & Ideation</span>, <span class="text-dark-3">Consultant</span>, <span class="text-dark-3">Google Analytics Report</span>, <span class="text-dark-3">Ads Planner</span>, <span class="text-dark-3">SPAM Content Production</span>.</p>
												</div> <!-- /.tt-accordion-content -->
											</div> <!-- /.tt-accordion-item -->
											...
											<div class="tt-accordion-item anim-fadeinup">
												<div class="tt-accordion-heading">
													<div class="tt-ac-head cursor-alter">
														<h3 class="tt-ac-head-title">Social Media Management</h3>
														<!-- <div class="tt-accordion-subtext">Nam min proin eget</div> -->
													</div>
												...
												<div class="tt-accordion-content max-width-800">
													<p>Kami akan membuat dan menjalankan strategi pemasaran digital di omnichannel; mulai dari penelitian, perencanaan, pembuatan konten, desain hingga pelaporan. Anda akan menjalin hubungan yang langgeng dengan kami, kolaborasi adalah inti dari apa yang kami lakukan. Layanan ini mencakup <span class="text-dark-3">Research & Ideation</span>, <span class="text-dark-3">Strategi & Planning</span>, <span class="text-dark-3">Content Production</span>, <span class="text-dark-3">Social Media Moderation</span>, <span class="text-dark-3">Ads Actiovation</span>, <span class="text-dark-3">Report & Review</span>.</p>
												</div> <!-- /.tt-accordion-content -->
											</div> <!-- /.tt-accordion-item -->
											...
											<div class="tt-accordion-item anim-fadeinup">
												<div class="tt-accordion-heading">
													<div class="tt-ac-head cursor-alter">
														<h3 class="tt-ac-head-title">Video & Motion</h3>
												...
												<div class="tt-accordion-content max-width-800">
													<p>Layanan ini mencakup <span class="text-dark-3">Promotional Video</span>, <span class="text-dark-3">Motion Graphics</span>, <span class="text-dark-3">Company Video Profile</span>, <span class="text-dark-3">Animation Video</span>.</p>
												</div> <!-- /.tt-accordion-content -->
											</div> <!-- /.tt-accordion-item -->
											...
											<div class="tt-accordion-item anim-fadeinup">
												<div class="tt-accordion-heading">
													<div class="tt-ac-head cursor-alter">
														<h3 class="tt-ac-head-title">Documentation</h3>
														<!-- <div class="tt-accordion-subtext">Condimentum sit amet</div> -->
													</div>
												...
												<div class="tt-accordion-content max-width-800">
													<p>Layanan ini mencakup <span class="text-dark-3">Product Photography</span>, <span class="text-dark-3">Event Documentation</span>, <span class="text-dark-3">Social Activity</span>, <span class="text-dark-3">Album</span>.</p>
												</div> <!-- /.tt-accordion-content -->
											</div> <!-- /.tt-accordion-item -->
											...
											<div class="tt-accordion-item anim-fadeinup">
												<div class="tt-accordion-heading">
													<div class="tt-ac-head cursor-alter">
														<h3 class="tt-ac-head-title">Apps</h3>
														<!-- <div class="tt-accordion-subtext">Condimentum sit amet</div> -->
													</div>
												...
												<div class="tt-accordion-content max-width-800">
													<p>Layanan ini mencakup <span class="text-dark-3">UI/UX Design</span>, <span class="text-dark-3">Mobile Apps Development</span>, <span class="text-dark-3">Desktop Apps Development</span>.</p>
												</div> <!-- /.tt-accordion-content -->
											</div> <!-- /.tt-accordion-item -->
							...
							<div class="tt-section-inner tt-wrap">
								...
								* Use class "tt-pn-stroke" to enable title stroke style.
								...
								<div class="tt-page-nav tt-pn-stroke tt-pn-center">
									<a href="<?php echo $siteurl ?>portfolio/" class="tt-pn-link anim-fadeinup" data-cursor="<i class='fas fa-arrow-right'></i>">
										<div class="tt-pn-title">Portofolio</div>
										<div class="tt-pn-hover-title">Portofolio</div>
									</a> <!-- /.tt-pn-link -->
									<div class="tt-pn-subtitle anim-fadeinup">Lihat Portofolio</div>
								</div>
								<!-- End page nav -->
								...
								<div class="footer-col-inner">
									...
									<div class="tt-copyright text-gray">
										<a href="https://natanpublishing.com" target="_blank" rel="noopener" class="tt-btn tt-btn-link">
											...
											<div data-hover="2022 <?php echo $sitetitle ?>">2022 <?php echo $sitetitle ?></div>
										</a>
									</div>
