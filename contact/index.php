...
<html lang="id">
	<head>
		...
		<!-- Title -->
		<title>Kontak | <?php echo $sitetitle ?></title>

		<!-- Mobile Meta -->
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		
		<!-- Meta Tag -->
		<meta name="title" content="Kontak | <?php echo $sitetitle ?>">
		<meta name="description" content="Kontak <?php echo $sitetitle ?>, <?php echo $sitedescription ?>.">
		<meta name="robots" content="index, nofollow">
		<meta name="author" content="<?php echo $sitetitle ?>">
		
		<!-- Meta Share -->
		<meta property="og:title" content="Kontak | <?php echo $sitetitle ?>">
		<meta property="og:image" content="<?php echo $siteurl ?>assets/img/thumb.jpg">
		<meta property="og:description" content="Kontak <?php echo $sitetitle ?>, <?php echo $sitedescription ?>.">
									...
									<div class="tt-ol-menu-inner tt-wrap">
										<div class="tt-ol-menu-content">
											...
											<ul class="tt-ol-menu-list">
												...
												<li class="active"><a href="<?php echo $siteurl ?>contact/">Kontak</a></li>
						...
						<div class="page-header-inner tt-wrap">
							...
							<div class="ph-caption max-width-1000">
								<div class="ph-caption-subtitle">
									<div class="ph-appear">Kontak Kami</div>
								</div>
								<h1 class="ph-caption-title">
									<div class="ph-appear">Kontak</div> <!-- You can use <br> to break a text line if needed -->
								</h1>
								<div class="ph-caption-title-ghost">
									<div class="ph-appear">Kontak</div>
								</div>
							</div>
								...
								<div class="tt-row tt-lg-row-reverse">
									<div class="tt-col-lg-4">
										...
										* Use prepared helper class "max-width-*" to add custom width if needed. Example: "max-width-800". More info about helper classes can be found in the file "helper.css".
										...
										<div class="tt-heading margin-bottom-8-p anim-fadeinup">
											...
											<h2 class="tt-heading-title">Informasi</h2> <!-- You can use <br> to break a text line if needed -->
										</div>
										<!-- End tt-Heading -->

										<div class="text-gray anim-fadeinup">
											<p>Hubungi kami lewat opsi dibawah, dengan senang hati kami akan melayani Anda dalam 24 jam.</p>
										</div>
										...
										<ul class="tt-contact-info padding-bottom-40 anim-fadeinup">
											<li>
												...
												Jl. Warakas Raya No. 1, Jakarta, Indonesia
											</li>
											<li>
											...
											<li>
												...
												natanpublishing@gmail.com
											</li>
											<li>
												<h6 class="no-margin-bottom margin-top-40">Sosial Media :</h6>
												<!-- Begin social buttons -->
												<div class="social-buttons">
													<ul>
														<li><div class="magnetic-wrap"><a href="https://tiktok.com/@natanpublishing/" class="magnetic-item not-hide-cursor" target="_blank" rel="noopener"><i class="fab fa-tiktok"></i></a></div></li>
														<li><div class="magnetic-wrap"><a href="https://facebook.com/natanpublishing/" class="magnetic-item not-hide-cursor" target="_blank" rel="noopener"><i class="fab fa-facebook-f"></i></a></div></li>
														<li><div class="magnetic-wrap"><a href="https://youtube.com/@natanpublishing/" class="magnetic-item not-hide-cursor" target="_blank" rel="noopener"><i class="fab fa-youtube"></i></a></div></li>
														<li><div class="magnetic-wrap"><a href="https://instagram.com/natanpublishing/" class="magnetic-item not-hide-cursor" target="_blank" rel="noopener"><i class="fab fa-instagram"></i></a></div></li>
													</ul>
												</div>
												<!-- End social buttons -->
											</li>
									...
									<div class="tt-col-lg-7">
										...
										* Use prepared helper class "max-width-*" to add custom width if needed. Example: "max-width-800". More info about helper classes can be found in the file "helper.css".
										...
										<div class="tt-heading margin-bottom-8-p anim-fadeinup">
											<!-- <h3 class="tt-heading-subtitle text-gray">Subtitle</h3> -->
											<h2 class="tt-heading-title">Kirim Pesan</h2> <!-- You can use <br> to break a text line if needed -->
										</div>
										<!-- End tt-Heading -->
										...
										* Use class "tt-form-sm" or "tt-form-lg" to change form size (no class = default size).
										...
										<form id="tt-contact-form" class="tt-form-filled anim-fadeinup">
											...
											<small class="tt-form-text"><em>Semua yang bertanda (*) wajib diisi!</em></small>

											<button type="submit" class="tt-btn tt-btn-primary margin-top-30">
												<div data-hover="Kirim Pesan">Kirim Pesan</div>
							...
							<div class="tt-section-inner tt-wrap">
								...
								* Use class "tt-pn-stroke" to enable title stroke style.
								...
								<div class="tt-page-nav tt-pn-stroke tt-pn-center">
									<a href="<?php echo $siteurl ?>" class="tt-pn-link anim-fadeinup" data-cursor="<i class='fas fa-arrow-right'></i>">
										<div class="tt-pn-title">Beranda</div>
										<div class="tt-pn-hover-title">Beranda</div>
									</a> <!-- /.tt-pn-link -->
									<div class="tt-pn-subtitle anim-fadeinup">Lihat Beranda</div>
								</div>
								<!-- End page nav -->
